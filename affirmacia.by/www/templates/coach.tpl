...
<head lang="ru">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>О центре, Центр личностного роста "Аффирмация"</title>
  <!-- Import main styles -->
...
<div class="container ">
<div class="row coachstyle">

      <div class="col-md-5 coachstyle-left-wr">
        <div class="coachstyle-left" id="{IMGID}"></div>
      </div>
      <div class="col-md-6 col-md-offset-1 coachstyle-right">
       <h2 class="stn-heading" >{COACHNAME}</h2><br>
      {COACHTEXT}
      <a href="index.php#coach"> << Назад к основному тренерскому составу</a>   
      </div><!--//.col-->
  ...
  <li><a href="#!"><i class="icon-odnoklassniki-square"></i></a></li>
